...
Even though the conf file was overwritten succesfully it took a little bit of time for Gedit to figure out that the colors should change too, but in the end it did and I had a sweet new color theme.
