...
(function (ArchetypeModule) {
    function selectArchetype() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!selectedArchetype) {
                throw new Errors_1.OperationCanceledError("Archeype not selected.");
            }
            // TO REMOVE
    ...
    function chooseTargetFolder(entry) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!cwd) {
                throw new Errors_1.OperationCanceledError("Target folder not selected.");
            }
            // TO REMOVE
    ...
    function executeInTerminal(archetypeGroupId, archetypeArtifactId, cwd) {
        return __awaiter(this, void 0, void 0, function* () {
            const cmd = [
                "archetype:generate",
            ...
            yield Utils_1.Utils.executeInTerminal(cmd, null, { cwd });
        });
    }
    function generateFromArchetype(entry, operationId) {
        return __awaiter(this, void 0, void 0, function* () {
            // select archetype.
            const { artifactId, groupId } = yield vscode_extension_telemetry_wrapper_1.instrumentOperationStep(operationId, "selectArchetype", selectArchetype)();
            vscode_extension_telemetry_wrapper_1.sendInfo(operationId, { archetypeArtifactId: artifactId, archetypeGroupId: groupId });
            // choose target folder.
            const cwd = yield vscode_extension_telemetry_wrapper_1.instrumentOperationStep(operationId, "chooseTargetFolder", chooseTargetFolder)(entry);
            // execute in terminal.
            yield vscode_extension_telemetry_wrapper_1.instrumentOperationStep(operationId, "executeInTerminal", executeInTerminal)(groupId, artifactId, cwd);
        });
    }
