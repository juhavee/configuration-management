...
function registerCommand(context, commandName, func, withOperationIdAhead) {
    const callbackWithTroubleshooting = vscode_extension_telemetry_wrapper_1.instrumentOperation(commandName, (_operationId, ...args) => __awaiter(this, void 0, void 0, function* () {
        try {
            return withOperationIdAhead ? yield func(_operationId, ...args) : yield func(...args);
        }
        catch (error) {
            if (error instanceof Errors_1.OperationCanceledError) {
                ...
                VSCodeUI_1.VSCodeUI.showTroubleshootingDialog(`Command "${commandName}" fails. ${error.message}`);
            }
            throw error;
        }
    }));
...
function doActivate(_operationId, context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        registerCommand(context, "maven.archetype.generate", (operationId, entry) => __awaiter(this, void 0, void 0, function* () {
            yield ArchetypeModule_1.ArchetypeModule.generateFromArchetype(entry, operationId);
        }), true);
